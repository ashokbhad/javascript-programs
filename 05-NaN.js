console.log("%c*** NaN Operations ***", "color: green");
var n1 = 0;
var n2 = 0;
var result = n1 / n2;
console.log(result);
...
console.log(`%c**** Uses cases of + operator ****`, "color: green");
...
console.log(`%c**** Implicit Conversion ****`, "color: green");
console.log("5" + 2);
console.log(10 + true);
console.log(10 + false);

console.log(`%c**** Explicit Conversion ****`, "color: green");
console.log(`%c*** String to Number ***`, "color: purple");
var n1 = "10";
var result = +n1;
...
console.log(`%c*** Number to String ***`, "color: purple");
var n2 = 20;
